...
## Automatic retrieval of server IP address and Ping・サーバのアドレスとPingの表示 <br>
  ...
  <br>
  5秒置きにゲームサーバーへPingを送信し、その値を表示します。
...
## Display of player information・プレイヤー情報の表示 <br>
  ...
  <br>
  ラウンド中にクリアしたプレイヤー数、脱落したプレイヤー数を表示できます。
...
<br>
  ...
  ○ 2.2.53 <br>
    ...
    ・ 「ショートサーキット」、「スピードサーキット」で【Your Position】が表示されてしまう問題を修正しました。 <br>
